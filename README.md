...
Sitio web responsive hecho como proyecto final del curso Full Stack “Codo a Codo”.
Tecnologías: HTML, CSS, JavaScript
🌐 Ver online

📌 Aplicación web para Refugio de animales

Aplicación en React usando componentes funcionales y hooks, con API para mostrar datos en tiempo real.
Funciones:
